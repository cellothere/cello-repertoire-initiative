...
const MobileFilterAccordion: React.FC<MobileFilterAccordionProps> = ({ filter, setFilter, accordionContent }) => {
      ...
      <div id="accordion">
        {Object.entries(accordionContent).map(([key, content], index) => (
          <div key={index}>
            ...
            <div id={`accordion-body-${index}`} className={`transition-max-height overflow-hidden ${openAccordion === index ? 'max-h-96' : 'max-h-0'} bg-white border border-gray-200`}>
              <div className="p-5">
